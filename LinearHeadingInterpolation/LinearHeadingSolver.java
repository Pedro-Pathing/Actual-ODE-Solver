...
public class LinearHeadingSolver {
    ...
    public LinearHeadingSolver(double vMax, double mass, double muK, double c1, double c2, Point2D p0, Point2D p3, double thetaT2, double boundaryTolerance, double submersibleDistanceTolerance, boolean isBlueAlliance, double thetaInitial, double angularVelocity, double robotWidth, double robotHeight) {
        v_max = vMax;
        this.mass = mass;
        mu_k = muK;
        c_1 = c1;
   ...
   public static void main(String[] args) {
        LinearHeadingSolver constantHeadingSolver = new LinearHeadingSolver(87, 16.09, 0.1, 10, 15, new Point2D.Double(10,5), new Point2D.Double(10, 110), FastMath.PI/2, 3, 3, true, 0, 6, 12.83, 15.75);
